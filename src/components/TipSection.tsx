  ...
  return (
    <section id="tip" className="relative py-24 px-6 bg-gradient-to-b from-white via-gray-50 to-blue-50 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 left-10 w-40 h-40 bg-[#0E3473] rounded-full blur-3xl"></div>
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            ClipboardMaster is free to use and always will be. If you find it helpful, consider supporting its development with a tip. Every contribution helps keep the app free and constantly improving.
          </p>
          ...
          {tipOptions.map((option, index) => (
            <button 
              ...
              className={`group relative p-8 rounded-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border-2 overflow-hidden ${
                option.highlighted 
                  ? 'bg-gradient-to-br from-[#0E3473] to-[#2563eb] text-white border-[#0E3473] shadow-2xl' 
                  : 'bg-white border-gray-200 text-[#0E3473] hover:border-[#0E3473] shadow-lg hover:shadow-2xl'
              }`}
            ...
            >
              ...
              {option.highlighted && (
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-3xl opacity-75 blur-lg group-hover:opacity-100 transition-opacity duration-300"></div>
              )}
              ...
              <div className="relative z-10">
                ...
                <div className={`text-3xl font-black mb-2 ${
                  option.highlighted ? 'text-white' : 'text-[#0E3473] group-hover:text-[#0E3473]'
                }`}>
                  {option.amount}
                </div>
                <div className={`text-lg font-medium ${
                  option.highlighted ? 'text-blue-100' : 'text-gray-600 group-hover:text-[#0E3473]'
                }`}>
                  {option.description}
                </div>
              ...
              <div className={`absolute inset-0 rounded-3xl ring-2 transition-all duration-300 ${
                option.highlighted 
                  ...
                  : 'ring-transparent group-hover:ring-[#0E3473]/30'
              }`}></div>
            </button>
          ))}
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 max-w-2xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-lg font-semibold text-[#0E3473]">Your Support Makes a Difference</span>
          </div>
          <p className="text-gray-600 leading-relaxed">
            All tips go directly to development costs, server maintenance, and keeping ClipboardMaster free for everyone. Thank you for supporting indie software development!
          </p>
        </div>
      </div>
    </section>
