...
export const metadata: Metadata = {
  title:
    "TREX Features - Advanced Clipboard Manager for macOS | Complete Feature List",
  description:
    "Discover all TREX clipboard manager features: unlimited history, smart search, privacy-first design, rich content support, keyboard shortcuts, and seamless macOS integration.",
  keywords:
    "clipboard manager features, macOS clipboard app, clipboard history, smart search, privacy clipboard, mac productivity features, clipboard shortcuts, text management",
  openGraph: {
    title: "TREX Features - Advanced Clipboard Manager for macOS",
    description:
      "Discover all TREX clipboard manager features: unlimited history, smart search, privacy-first design, and seamless macOS integration.",
    type: "website",
    url: "/features",
  },
  twitter: {
  ...
  const features = [
    {
      ...
      description:
        "Store unlimited clipboard entries with intelligent categorization. Never lose important copied content again.",
      details: [
    ...
    },
    {
      ...
      description:
        "Find any clipboard item instantly with powerful search functionality. Search by text, date, or content type.",
      details: [
    ...
    },
    {
      ...
      description:
        "Mark important clips as favorites for quick access and better organization.",
      details: [
    ...
    },
    {
      ...
      description:
        "Your clipboard data stays private on your Mac. No cloud sync, no tracking, just pure local storage.",
      details: [
    ...
    },
    {
      ...
      title: "Quick Access",
      description:
        "Access your clipboard history with keyboard shortcuts and menu bar integration.",
      details: [
    ...
    },
    {
      ...
      description:
        "Built specifically for macOS with native performance and seamless system integration.",
      details: [
    ...
    },
    {
      ...
      description:
        "Essential features to boost your daily workflow and productivity.",
      details: [
      ...
      <section className="relative bg-gradient-to-br from-[#023531] via-[#034a3f] to-[#5FB845] text-white py-12 md:py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-6 md:mb-8 text-white/80 max-w-4xl mx-auto leading-relaxed px-4">
            ...
            Features designed to boost your productivity and protect your
            privacy.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Link
              href="/#download"
              className="group relative bg-white text-[#023531] px-8 md:px-10 py-4 md:py-5 rounded-2xl font-bold text-lg transition-all duration-500 shadow-2xl hover:shadow-3xl flex items-center gap-3 overflow-hidden w-full max-w-sm justify-center"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              TREX combines essential clipboard functionality with elegant
              design, giving you a great clipboard management experience on
              macOS.
            </p>
          </div>
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <ul className="space-y-2">
                      {feature.details.map((detail, detailIndex) => (
                        ...
                        >
                          <svg
                            className="w-3 h-3 sm:w-4 sm:h-4 text-[#5FB845] mt-0.5 flex-shrink-0"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
      ...
      <section className="py-12 md:py-16 lg:py-24 px-4 md:px-6 bg-gradient-to-r from-[#023531] to-[#5FB845]">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg sm:text-xl mb-6 md:mb-8 text-white/90 px-4">
            Join Mac users who have discovered the power of TREX clipboard
            manager.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            ...
            >
              ...
              <span className="relative z-10">Download TREX Now!</span>
              <div className="absolute inset-0 ring-2 ring-white/20 rounded-2xl group-hover:ring-white/40 transition-all duration-300"></div>
            </Link>
            <Link
              href="/"
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Complete feature overview of TREX clipboard manager: unlimited history, smart search, privacy-first design, rich content support, and seamless macOS integration.",
